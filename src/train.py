...
def train():
    ...
    with tf.Graph().as_default():
        ...
        # 3. read data, FLAGS.image_set = train, FLAGS.data_path = ./data/KITTI
        imdb = kitti(FLAGS.image_set, FLAGS.data_path, mc)

        # save model size, flops, activations by layers
        # FLAGS.train_dir = save trained model
        ...
        def _load_data(load_to_placeholder=True):
            ...
            feed_dict = {
                ...
                box_delta_input: sparse_to_dense(
                    bbox_indices, [mc.BATCH_SIZE, mc.ANCHORS, 5],
                    box_delta_values),
